...
trimDirectiveWhitespaces="true" %> <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <div class="wrap">
      <div class="container">
              ...
              <c:forEach var="product" items="${list}" varStatus="status">
                <tr class="text-center align-middle">
                    <th scope="row">${status.count}</th>
                         ...
                         <td class="text-center align-middle">${product.limit_date}</td>
                         <td class="text-center align-middle">
                            <a
                                  href="/editProductForm?index=${status.index}"
                         ...
                         <td class="text-center align-middle">
                                <a
                                  href="/deleteProduct?index=${status.index}"
        ...
        <div style="clear: both" class="d-flex justify-content-center">
          <a id="addProductButton" href="/addProductForm" class="btn btn-danger fw-bold w-25" role="button"
            >상품 추가하기 !</a
          >
        </div>
      </div>
